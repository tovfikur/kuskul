...
def upgrade():
    ...
    if 'purchase_request_lines' not in tables:
        op.create_table('purchase_request_lines',
            sa.Column('id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('purchase_request_id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('item_id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('qty', sa.Integer(), nullable=False),
            sa.Column('note', sa.String(length=500), nullable=True),
    ...
    if 'purchase_orders' not in tables:
        op.create_table('purchase_orders',
            ...
            sa.Column('created_from_purchase_request_id', sa.Uuid(as_uuid=True), nullable=True),
            sa.Column('status', sa.String(length=20), nullable=False),
            sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
            sa.Column('created_by_user_id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    ...
    if 'goods_receipts' not in tables:
        op.create_table('goods_receipts',
            ...
            sa.Column('received_by_user_id', sa.Uuid(as_uuid=True), nullable=False),
            sa.ForeignKeyConstraint(['school_id'], ['schools.id'], ),
            sa.ForeignKeyConstraint(['purchase_order_id'], ['purchase_orders.id'], ),
            sa.ForeignKeyConstraint(['location_id'], ['inventory_locations.id'], ),
    ...
    if 'goods_receipt_lines' not in tables:
        op.create_table('goods_receipt_lines',
            sa.Column('id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('goods_receipt_id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('purchase_order_line_id', sa.Uuid(as_uuid=True), nullable=False),
            sa.Column('qty_received', sa.Integer(), nullable=False),
    ...
    if 'assets' not in tables:
        op.create_table('assets',
            ...
            sa.Column('custodian_user_id', sa.Uuid(as_uuid=True), nullable=True),
            sa.Column('status', sa.String(length=20), nullable=False),
            sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
            sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
            sa.ForeignKeyConstraint(['school_id'], ['schools.id'], ),
    ...
    if 'maintenance_tickets' not in tables:
